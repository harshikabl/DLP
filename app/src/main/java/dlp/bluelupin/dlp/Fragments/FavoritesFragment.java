...
public class FavoritesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_favotites, mTabHost);
        context = getActivity();
        init(view);
        return view;
    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FavoritesListFragment(), "CHAPTERS");
        adapter.addFrag(new FavoritesListFragment(), "TOPICS");
